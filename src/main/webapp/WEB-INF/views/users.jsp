    ...
    <table class="easyui-datagrid" id="userList" title="用户列表" 
	    ...
	    <thead>
	        <tr>
	            ...
	            <th data-options="field:'insert_time',width:130,align:'center',formatter:formatDate">创建日期</th>
	            <th data-options="field:'update_time',width:130,align:'center',formatter:formatDate">更新日期</th>
	        </tr>
	    </thead>
	</table>
	</div>
<div id="userAdd" class="easyui-window" title="新增用户" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/rest/page/user-add'" style="width:800px;height:600px;padding:10px;">
        The window content.
</div>
